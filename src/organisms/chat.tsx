    ...
    <div className="relative h-full overflow-hidden">
      ...
      <div className="flex flex-col h-full relative">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto px-2 sm:px-3 md:px-4 pt-4 sm:pt-6 md:pt-8 pb-24 sm:pb-28 md:pb-32 space-y-4 sm:space-y-5 md:space-y-6">
            {/* Bot message */}
              ...
              <div className="flex justify-start">
                <div className="flex items-start gap-2 sm:gap-3 max-w-[85%] sm:max-w-[80%]">
                  <div className="flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-violet-200 rounded-md flex items-center justify-center">
                    <Bot
                      className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-violet-800"
                      strokeWidth={2.5}
                    />
                  </div>
                  <div className="bg-white rounded-sm p-2 sm:p-3">
                    <p className="text-black text-xs sm:text-sm leading-relaxed text-left flex items-center gap-1">
                      <Sparkles
                        className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-amber-300"
                        strokeWidth={2.5}
                        fill="currentColor"
                      />
                      <strong>Summary :</strong>
                    </p>
                    <p className="text-black text-xs sm:text-sm leading-relaxed text-left prose prose-sm sm:prose-base">
                      {parse(summary)}
                    </p>
                  </div>
                </div>
